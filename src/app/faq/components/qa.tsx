    ...
    <div className="mb-14" onClick={handleOpen}>
      ...
      >
        <p className="text-display-r text-base">
          We have tested Postcards with the following mail clients: Gmail, AOL,
          Apple Mail, Android Mail, Outlook.com, Yahoo mail, Thunderbird,
          Microsoft Outlook, Outlook Express, Windows Mail, Lotus Notes. We also
          tested them with major mailing systems including: Mailchimp, Shopify,
          Constant Contact, Mailgun, HubSpot, Benchmark, Marketo, Campaign
          Monitor, Wordpress, MoonMail, Sendwithus, Salesforce.
        </p>
      </div>
    </div>
  );
